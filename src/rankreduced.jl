...
ẑ_at_θ(rrprob::RankReducedMuseProblem, x, θ, z₀) = ẑ_at_θ(rrprob.prob, x, modes_to_original_θ(rrprob, θ), z₀)
...
∇θ_logLike(rprob::ReparameterizedMuseProblem, x, θ, z) = _jacobian(ForwardDiffAD(), rprob.f, θ)' * ∇θ_logLike(rprob.prob, x, rprob.f(θ), z)
